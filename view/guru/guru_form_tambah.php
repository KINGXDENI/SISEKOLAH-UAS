                        ...
                        <div class="card-body bg-dark">
                            ...
                            <div class="row pb-4">
                                <div class="col cap text-warning font-weight-bold">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>Email</label>
                                        <input type="email" class="form-control" name="email" autocomplete="off" placeholder="Masukan Email" required>
                                ...
                                <div class="col cap text-warning font-weight-bold">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>No. HP</label>
                                        <input type="text" class="form-control" name="no_hp" maxlength="12" onKeyPress="return goodchars(event,'0123456789',this)" autocomplete="off" placeholder="Masukan Nomor Hp" required>
