<?php
$cekdat = mysqli_query($db, "SELECT * FROM tbl_waktu");
                            ...
                            while ($data = mysqli_fetch_assoc($query)) { ?>
                                <tr class="cap centr">
                                    ...
                                    <td>
                                        ...
                                        <a title="Hapus" id="btn-del" class="btn btn-danger" href="view/waktu/waktu_proses_hapus.php?id_waktu=<?php echo $data['id_waktu']; ?>"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
...
<?php
    ...
    <script>
        document.location = 'index.php?page=tambahw';
    </script>
<?php
}
?>