									...
									while ($data = mysqli_fetch_assoc($query)) { ?>
										<tr>
											...
											if ($row > 0) { ?>
												...
												<td class="center"><?php echo $data['nim']; ?></td>
												<td class="center"><?php echo $data['nama']; ?></td>
												<td class="center"><?php echo $data['tempat_lahir']; ?>, <?php echo date(
																												'd-m-Y',
																												strtotime($data['tanggal_lahir'])
																											); ?></td>
												<td class="center"><?php echo $data['jenis_kelamin']; ?></td>
												<td class="center"><?php echo $data['nama_jurusan']; ?></td>
												<td class="center"><?php echo $data['agama']; ?></td>
