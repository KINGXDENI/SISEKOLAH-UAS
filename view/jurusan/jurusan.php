<?php
$cekdat = mysqli_query($db, "SELECT * FROM tbl_jurusan");
                        ...
                        <tr class="cap centr">
                            ...
                            if ($level == 'Admin') { ?>
                                <td>
                                    ...
                                    <a title="Hapus" id="btn-del" class="btn btn-danger" href="view/jurusan/jurusan_proses_hapus.php?kode_jurusan=<?php echo $data['kode_jurusan']; ?>" ><i class="fas fa-trash"></i></a>
                                <?php
                            } ?>
                                </td>
                        </tr>
...
<?php
    ...
    <script>
        document.location = 'index.php?page=tambahj';
    </script>
<?php
}
?>