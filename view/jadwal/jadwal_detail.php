						...
						<div class="row">
							<div class="col cap text-warning font-weight-bold">
								<div class="form-group col-md-12">
									...
									<input type="hidden" class="form-control" name="kode_jadwaldt" value="<?= $kjd_kat ?>">
									<input type="text" class="form-control" name="kode_jadwal" autocomplete="off" value="<?= $kode_jadwal ?>" placeholder="Masukan ID Jadwal" required readonly="readonly">
								...
								<div class="form-group col-md-12">
									...
									<select class="form-control mb-3" name="id_waktu" autocomplete="off" required>
										...
										while ($data = mysqli_fetch_assoc($querywkt)) {
											echo "<option value=' " . $data['id_waktu'] . "'>" . $data['jam_masuk'] . "-" . $data['jam_keluar'] . "</option>";
										}
										?>
								...
								while ($data = mysqli_fetch_assoc($query)) { ?>
									<tr class="cap">
										...
										<td width="90" class="center">
											<a title="Hapus" id="btn-del" class="btn btn-danger" href="view/jadwal/proses_hapus_jadwaldetail.php?kode_jadwal=<?php echo $data['kode_jadwal']; ?>&kode_jadwaldt=<?php echo $data['kode_jadwaldt']; ?>"><i class="fas fa-trash"></i></a>
										</td>
									</tr>
								<?php
									$no++;
