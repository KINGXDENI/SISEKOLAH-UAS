<?php
$cekdat = mysqli_query($db, "SELECT * FROM tbl_matapelajaran");
                        ...
                        <tr class="cap centr">
                            ...
                            if ($level == 'Admin') { ?>
                                <td>
                                    ...
                                    <a title="Hapus" class="btn btn-danger" href="view/mapel/mapel_proses_hapus.php?kode_mapel=<?php echo $data['kode_mapel']; ?>" id="btn-del"><i class="fas fa-trash"></i></a>
                                </td>
                            <?php
                            } ?>
                        </tr>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-end">
                    ...
                    // jika halaman aktif > 1, maka button Sebelumnya = aktif
                        ...
                        <li class="page-item"><a class="page-link text-warning bg-dark" href="?page=mapel&hal=<?php echo $page - 1 ?>">Sebelumnya</a></li>
                    <?php } ?>
                    <!-- Button untuk link halaman 1 2 3 ... -->
                    <?php
                    for ($x = 1; $x <= $halaman; $x++) { ?>
                        <li class="page-item"><a class="page-link text-warning bg-dark" href="?page=mapel&hal=<?php echo $x ?>"><?php echo $x ?></a></li>
                    <?php } ?>
                    ...
                    // jika halaman aktif <= jumlah halaman, maka button Selanjutnya = aktif
                        ...
                        <li class="page-item"><a class="page-link text-warning bg-dark" href="?page=mapel&hal=<?php echo $page + 1 ?>">Selanjutnya</a></li>
                    <?php } ?>
                </ul>
            </nav>
        </div>
...
<?php
    ...
    <script>
        document.location = 'index.php?page=tambahm';
    </script>
<?php
}
?>