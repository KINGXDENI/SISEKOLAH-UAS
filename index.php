...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="assets/css/styleeeeee.css">
...
<body class="bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item <?= $jawalaktif ?>">
                            ...
                            if ($level == 'Siswa') {
                            ?>
                                <a class="nav-link text-white" href="?page=jadwalsiswa"><i class="fas fa-bell aa mr-2"></i>Jadwal</a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            ?>
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="#"> <i class="fas fa-print aa mr-2"></i> <span class="aa bb ">Transaksi</span></a>
                                </div>
    ...
    <div class="container-fluid" id="container">
        ...
        elseif ($_GET['page'] == 'detailg') {
            ...
            include "view/jadwal/jadwal_detailsiswa.php";
        }
